...
PERCENTAGE_OF_TRAIN_SET_TO_USE = 0.5 #1 #1.0
PERCENTAGE_OF_VAL_SET_TO_USE = 0.05 #1 #0.05 
BATCH_SIZE = 8 #16
EFFECTIVE_BATCH_SIZE = 32 #64 #64  # batch size after gradient accumulation
NUM_WORKERS = 8 #10
EPOCHS = 20
LR = 1e-4 #5e-5
...
EVALUATE_EVERY_K_BATCHES = 512 #2400 #24 #2400 #for 0.1 of training subset (1303 im evl at 326)
...
NUM_BATCHES_TO_PROCESS_FOR_LANGUAGE_MODEL_EVALUATION = 10  # for evaluation of bleu, rouge-l and meteor
