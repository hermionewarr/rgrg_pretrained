...
"""
RUN = 6
RUN_COMMENT = """Subset of Plueral effusion and no findings."""
SEED = 42
PRETRAIN_WITHOUT_LM_MODEL = False
IMAGE_INPUT_SIZE = 512
PERCENTAGE_OF_TRAIN_SET_TO_USE = 0.1 #1.0
PERCENTAGE_OF_VAL_SET_TO_USE = 0.1 #0.05 
BATCH_SIZE = 2 #16
EFFECTIVE_BATCH_SIZE = 16 #64 #64  # batch size after gradient accumulation
NUM_WORKERS = 8 #10
EPOCHS = 50
LR = 5e-5
...
EVALUATE_EVERY_K_BATCHES = 240 #24 #2400 #for 0.1 of training subset (1303 im evl at 326)
