...
#path_mimic_cxr_report = DATA_PATH+"physionet.org/files/mimic-cxr/2.0.0/mimic-cxr-reports/"
path_full_dataset = DATA_PATH+"rgrg/dataset-with-reference-reports"
...
path_test_set_evaluation_scores_txt_files = MODEL_INFO_PATH+"src/chest-x-ray-report-generation"